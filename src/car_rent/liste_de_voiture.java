 ...
 * @author abdelrahman
 */
public class liste_de_voiture extends javax.swing.JFrame {

    /**
     * Creates new form liste_de_voiture
     */
    public liste_de_voiture() {
        initComponents();
        showTableData();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("LISTES DES VOITURES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(liste_de_voiture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new liste_de_voiture().setVisible(true);
            }
        });
    }

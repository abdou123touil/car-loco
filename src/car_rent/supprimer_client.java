 ...
 * @author abdelrahman
 */
public class supprimer_client extends javax.swing.JFrame {

    /**
     * Creates new form supprimer_client
     */
 ...
 public void showTableData(){
            ...
            if (selectedRow != -1) {
                ...
                try{
                    ...
                    Connection con = DriverManager.getConnection(
                        ...
                        "root", "Asusthgu.1");
                    Statement stmt = con.createStatement();
                    String deleteQuery = "DELETE FROM client WHERE id_client = " + value;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(supprimer_client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new supprimer_client().setVisible(true);
            }
        });
    }

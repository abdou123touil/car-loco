 ...
 * @author abdelrahman
 */
public class supprimer_voitre extends javax.swing.JFrame {

    /**
     * Creates new form supprimer_voitre
     */
    public supprimer_voitre() {
        initComponents();
        showTableData();  
    ...
    private void initComponents() {
        ...
        jLabel11.setText("SUPPRIMER VOITURES");
    ...
    try{
             Class.forName ("com.mysql.cj.jdbc.Driver").newInstance();
                ...
                "root", "Asusthgu.1");
            String sql=("select* from voiture order by id_voiture");
...
int column = 0;
int confirmation = JOptionPane.showConfirmDialog(null, "vouz ete sure de supprimer cette voiture?", "Confirmation", JOptionPane.YES_NO_OPTION);
...
if (selectedRow != -1) {
    String value = liste_voiture.getModel().getValueAt(selectedRow, column).toString();
     try{
                ...
                Connection con = DriverManager.getConnection(
                    ...
                    "root", "Asusthgu.1");
                 Statement stmt = con.createStatement();
                 String deleteQuery = "DELETE FROM voiture WHERE id_voiture = " + value;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(supprimer_voitre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new supprimer_voitre().setVisible(true);
            }
        });
    }
